...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::UpperAllLettersOfWord(CurrencyCode);
    ...
    {
        Country = clsString::UpperAllLettersOfWord(Country);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::UpperAllLettersOfWord(Currency.Country()) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
